"""
Django settings for MeetAndClimb project.
...
ROOT_URLCONF = 'MeetAndClimb.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'WebApp.context_processor.my_context_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'MeetAndClimb.wsgi.application'
